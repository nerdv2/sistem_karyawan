...
<body>
    <div class="app app-default">
        ...
        <div class="app-container">
                        ...
                        <div class="card-body no-padding table-responsive">
                           <?php
                                ...
                                foreach($query as $row){
                                    $aksi = "<a class='btn btn-secondary' href='".site_url('statuskawin/edit/'.$row->id)."'>Edit</a>
                                    <a class='btn btn-danger' href='".site_url('statuskawin/delete/'.$row->id)."'>Delete</a>";
            ...
            <a href="<?php echo site_url("statuskawin/add"); ?>">
